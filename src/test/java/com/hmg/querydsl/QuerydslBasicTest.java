...
//                .fetchOne();
    ...
    public void searchAndParam() {
        Member findMember = queryFactory
                .selectFrom(member)
                .where(
                        member.username.eq("member1"), // and 대신 , 도 가능
    ...
    public void paging1() {
        List<Member> result = queryFactory
                ...
                .offset(1) // 0부터 시작, n개를 스킵하겠다.
                .limit(2) // 몇개 가져올지 (paging 크기)
                .fetch();
    ...
    public void paging2() {
        ...
        assertThat(queryResults.getTotal()).isEqualTo(4); // 전체 갯수 (paging 적용 전)
        assertThat(queryResults.getLimit()).isEqualTo(2); // paging 크기
    ...
    public void findDtoByJPQL() {
        // JPQL에서는 new 를 사용해야 새로 만든 dto로 프로젝션이 가능함. 패키지 경로 모두 지정해야해서 지저분함.
        List<MemberDto> result = em.createQuery("select new com.hmg.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
                .getResultList();
    ...
    @Test
    public void dynamicQuery_BooleanBuilder() { // 동적쿼리 - BooleanBuilder
    ...
    @Test
    public void dynamicQuery_WhereParam() { // 동적쿼리 - Where 다중 파라미터 사용
        String usernameParam = "member1";
        Integer ageParam = 10;
    ...
    public void sqlFunction2() {
        ...
        List<String> result = queryFactory
                ...
                .where(member.username.eq(
                        ...
                        member.username.lower() // 기본적인것들은 제공이됨
                ))
                .fetch();
